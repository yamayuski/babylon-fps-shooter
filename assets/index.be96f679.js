var e=Object.defineProperty,t=(t,n,a)=>(((t,n,a)=>{n in t?e(t,n,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[n]=a})(t,"symbol"!=typeof n?n+"":n,a),a);import{B as n,V as a,S as s,C as o,T as i,G as r,a as c,D as l,b as h,c as d,d as u,e as m,f as p,g as b,R as w,F as g,A as f,h as y,i as M,E as C}from"./vendor.00afebc4.js";!function(){const e=document.createElement("link").relList;if(!(e&&e.supports&&e.supports("modulepreload"))){for(const e of document.querySelectorAll('link[rel="modulepreload"]'))t(e);new MutationObserver((e=>{for(const n of e)if("childList"===n.type)for(const e of n.addedNodes)"LINK"===e.tagName&&"modulepreload"===e.rel&&t(e)})).observe(document,{childList:!0,subtree:!0})}function t(e){if(e.ep)return;e.ep=!0;const t=function(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerpolicy&&(t.referrerPolicy=e.referrerpolicy),"use-credentials"===e.crossorigin?t.credentials="include":"anonymous"===e.crossorigin?t.credentials="omit":t.credentials="same-origin",t}(e);fetch(e.href,t)}}();
/**
 * @author Masaru Yamagishi <yamagishi.iloop@gmail.com>
 * @license Apache-2.0
 */
class v{constructor(e){t(this,"camera"),t(this,"dashSpeed",.8),t(this,"walkSpeed",.5),t(this,"onKeyboardObservable",null),this.camera=e,e.keysUp=["W".charCodeAt(0)],e.keysDown=["S".charCodeAt(0)],e.keysLeft=["A".charCodeAt(0)],e.keysRight=["D".charCodeAt(0)]}attachControl(e){e=d.BackCompatCameraNoPreventDefault(arguments);const t=this.camera.getScene().onKeyboardObservable.add((t=>{1===t.type&&"ShiftLeft"===t.event.code?this.camera.speed=this.dashSpeed:this.camera.speed=this.walkSpeed,e||t.event.preventDefault()}));this.onKeyboardObservable=t}detachControl(){this.onKeyboardObservable&&(this.camera.getScene().onKeyboardObservable.remove(this.onKeyboardObservable),this.onKeyboardObservable=null)}getClassName(){return"ShooterCameraDashInput"}getSimpleName(){return"dash"}}
/**
 * @author Masaru Yamagishi <yamagishi.iloop@gmail.com>
 * @license Apache-2.0
 */
class S{constructor(e,n){t(this,"engine"),t(this,"scene"),t(this,"camera"),t(this,"mainLight"),t(this,"shadowGenerator"),t(this,"gunfireSound"),t(this,"onMouseClick",(()=>{this.engine.isPointerLock||this.engine.enterPointerlock();const e=this.camera.globalPosition.clone(),t=this.camera.getDirection(a.Forward()),n=new w(e,t,200);this.gunfireSound&&this.gunfireSound.play();const s=this.scene.pickWithRay(n,(e=>null!==e.name.match(/^Mob.+/)));s&&s.pickedMesh&&s.pickedMesh.dispose()})),t(this,"onResize",(()=>{this.engine.resize()})),this.engine=e;const s=this.engine.getRenderingCanvas();if(!s)throw new Error("Unknown canvas element");this.scene=new u(this.engine,n),this.camera=function(e,t){const n=new a(200*Math.random()-100,2,200*Math.random()-100),s=new g("MainCamera",n,t);return s.setTarget(a.Zero()),s.inputs.add(new v(s)),s.attachControl(e,!0),s.applyGravity=!0,s.ellipsoid=new a(1.2,1.2,1.2),s.checkCollisions=!0,s}(s,this.scene),this.mainLight=
/**
 * @author Masaru Yamagishi <yamagishi.iloop@gmail.com>
 * @license Apache-2.0
 */
 ...
 * @license Apache 2.0
 */
async function(e){const t=new C(e,!0,{alpha:!1,antialias:!0,audioEngine:!0,autoEnableWebVR:!1,depth:!0},!0),n=new S(t);await n.start()})(document.getElementById("app")).catch((e=>console.error(e)));
